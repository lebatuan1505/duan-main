...
<form class="price-slider-amount" method="POST" action="?act=search">
   <div class="label-input">
      ...
      <button class="filter-btn border-0 p-1" name="search" type="submit"><i
   ...
   <tbody>
      ...
      foreach ($list as $pro) {
         ...
         <tr>
            ...
            <td scope="row" class="text-nowrap" width="1px">
               <a href="<?= $sua ?>"><button type="button" class="btn btn-warning" name="edit-category"><i
                        class="fa-solid fa-pen"></i> </button></a>
               <a href="<?= $xoa ?>"><button type="button" class="btn btn-danger" name="deletecate"
                     onclick="return confirm('Những sản phẩm trong danh mục này cũng sẽ bị xóa, xác nhận ?')"><i
                        class="fa-solid fa-trash fa-l"></i> </button></a>
