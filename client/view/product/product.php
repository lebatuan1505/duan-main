      ...
      <div class="product">
        ...
        <div class="overlay">
          <div class="content">
            ...
            <button type="submit" name="addToCart" class=" bg-success text-light rounded p-1" >Thêm vào giỏ hàng</button>
            <a href="?act=viewProduct&id_sp=<?=$sp['id_sp']?>&id_dm=<?=$sp['id_dm']?>" class="btn bg-dark text-light rounded p-1 ">Xem cho tiết</a>
