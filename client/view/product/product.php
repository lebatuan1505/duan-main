            ...
            <div class="price-filter">
              ...
              <form class="price-slider-amount" method="POST" action="?act=search">
                <div class="label-input">
                  ...
                  <button class="filter-btn border-1" name="search" type="submit"><i
          ...
          <div class="container text-center">
            <div class="row">
              ...
              foreach ($Product as $sp) { ?>
                <div class="col-4 mt-3 mb-3 mr-3" style="height: 500px;">
                    ...
                    <form action="?act=add-to-cart" method="POST" enctype="multipart/form-data">
                      <div class="product">
                        ...
                        <div class="overflow-hidden w-100" style="height: 300px;">
                          <img src="../img/<?= $sp['image_sp'] ?>" alt="Product 1" class="w-100 h-100">
                        </div>
                          ...
                          <div class="content">
                            ...
                            <div class="align-items-end ">
                              <button type="submit" name="addToCart"
                                class=" bg-success text-light rounded p-1 border-0">Thêm vào giỏ
                                hàng</button>
                              <a href="?act=viewProduct&id_sp=<?= $sp['id_sp'] ?>&id_dm=<?= $sp['id_dm'] ?>"
                                class="btn bg-dark text-light rounded p-1 border-0">Xem cho tiết</a>
                            </div>
