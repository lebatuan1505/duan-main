  ...
  <div class="row justify-content-between">
    ...
    <div class="col-lg-6">
      ...
      <div class="container">
          ...
          <div class="col-md-4 ml-2">
            <div class="col-md-4 ml-2">
              ...
              <div class="form-group d-flex">
                <div class="border p-1 me-2 size-option" data-value="36">36</div>
                <div class="border p-1 me-2 size-option" data-value="37">37</div>
                <div class="border p-1 me-2 size-option" data-value="39">39</div>
                <div class="border p-1 me-2 size-option" data-value="39">39</div>
        ...
        <div>
          ...
          <input type="number" name="soluongcart" id="quantityInput" value="1" min="1" max="<?= $Product['soluong'] ?>"
    ...
    <div class="row mt-4">
      <div class="col-lg-12 fs-5 ">
        ...
        <a href="#" class="d-flex justify-content-center" onclick="expandDescription()" id="toggleDescription">Xem
          thêm</a>
            ...
            <div class="product">
              ...
              <div class="overlay">
                <div class="content">
                  ...
                  <button class="btn btn-success" type="submit" name="addToCart" onclick="setAction('add-to-cart')">Thêm
                    vào giỏ hàng</button>
