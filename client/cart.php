                    ...
                    if (isset($_SESSION['cart'])) {
                        foreach ($cart as $ca) {
                            ...
                            <tr class="cart_item container">
                                ...
                                <td>
                                    <input type="number" value="<?= $ca['soluongcart'] ?>" min="1"
                                        max="<?= $Product['soluong'] ?>" id="quantity_<?= $ca['id_sp'] ?>"
                                        oninput="updateQuantity(<?= $ca['id_sp'] ?>, this.value)" class="inp-sl"
                                        onclick="reloadPage()">
                                </td>
                                <td class="itotal"><?= number_format(($ca['price_sp'] * $ca['soluongcart']), 0, '.', '.') ?> ₫
                                </td>
                            </tr>
                            <?php
